...
def predict(prompt, style, audio_file_pth, mic_file_path, use_mic, agree):
    ...
    if len(prompt) > 1000000:
        text_hint += f"[ERROR] Text length limited to 300 characters for this demo, please try shorter text. You can clone our open-source repo and try for your usage \n"
        gr.Warning(
